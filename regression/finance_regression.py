...
dictionary = pickle.load(open("../final_project/final_project_dataset_modified.pkl", "rb"))# , encoding='bytes')
...
# ## These two lines are to see the effect of swapping the high salary, low bonus between sets
